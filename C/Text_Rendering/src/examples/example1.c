...
enum Apl_Return_Types apl_render(struct Apl_Window_State *ws)
{
    ...
    struct Atr_Vec2 bounding_box2 = atr_text_line_draw_outline(font_pixels, &font, (uint8_t *)str2, top_left_x, top_left_y + bounding_box1.y + top_left_y, letter_hight, spacing, 0xFFFFFFFF, -1, (offzoom));
