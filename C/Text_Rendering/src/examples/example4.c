...
enum Apl_Return_Types apl_render(struct Apl_Window_State *ws)
{
    ...
    struct Atr_Vec2 bounding_box1 = atr_text_line_draw(font_pixels, &font, (uint8_t *)str1, top_left_x, top_left_y, letter_hight, spacing, ADL_COLOR_WHITE_hexARGB, -1, adl_offset_zoom_to_atr_offset_zoom(offzoom));
