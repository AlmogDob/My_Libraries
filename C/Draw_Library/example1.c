...
void setup(game_state_t *game_state)
{
    ...
    figure1 = adl_figure_alloc(100, 70, (Point){100, 100, 0, 0});
    figure2 = adl_figure_alloc(600, 500, (Point){190, 100, 0, 0});
...
{
    adl_curves_plot_on_figure(figure1);
    adl_curves_plot_on_figure(figure2);

    adl_figure_copy_to_screen(game_state->window_pixels_mat, figure1);
