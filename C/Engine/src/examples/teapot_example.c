...
void setup(game_state_t *game_state)
{
    ...
    Tri_mesh teapot_mesh = ae_tri_mesh_get_from_file(file_path);
    // ae_tri_mesh_flip_normals(teapot_mesh);	
    ada_appand(Tri_mesh, game_state->scene.original_tri_meshes, teapot_mesh);
