...
void blur_gaussian_bw(Mat2D_uint32 des_u32, Mat2D_uint32 src_u32, mat2D_real std)
{
...
void blur_gaussian_rgba_fast(Mat2D_uint32 des_u32, Mat2D_uint32 src_u32, mat2D_real std)
{
    /* https://en.wikipedia.org/wiki/Gaussian_blur */
...
enum Apl_Return_Types apl_setup(struct Apl_Window_State *ws)
{
    ...
    blur_gaussian_rgba_fast(results, image_pixels, 1.5);
